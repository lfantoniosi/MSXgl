...
.macro INIT_P3_TO_P0
	...
	crt0_p3_to_p0:
		...
		; E = current SLOT config (P3|P2|P1|P0)
		; D = current SLTSL reg (P3)
		...
		; RAM deep search
		; this routine search for RAM on P0. It searches each slot/subslot as the RAM might be fragmented (Victor HC-80 or Sony HB-F900 rev1)
